    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(db_comment='Название достижения.', help_text='Название достижения.', max_length=100, unique=True, verbose_name='Название достижения')),
                ...
                ('reward_points', models.PositiveSmallIntegerField(db_comment='Количество заморозок за достижение.', default=0, help_text='Количество заморозок за достижение.', verbose_name='Заморозк')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('workout', models.JSONField(db_comment='Описанные этапы тренировки', help_text='Описанные этапы тренировки в json.', verbose_name='Этапы тренировки')),
                ('workout_info', models.CharField(db_comment='Описание тренировки дополнительно к этапам', help_text='Описание тренировки.', max_length=100, verbose_name='Описание тренировки')),
            ],
            options={
                'verbose_name': 'День',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('motivation_phrase', models.CharField(db_comment='Мотивационная фраза на дне тренировки.', help_text='Мотивационная фраза', max_length=150, verbose_name='Мотивационная фраза')),
                ('route', models.JSONField(db_comment='Маршрут тренировки.', help_text='Маршрут тренировки.', verbose_name='Маршрут')),
                ...
                ('training_day', models.ForeignKey(db_comment='День, к которому относится тренировка.', help_text='День тренировки.', on_delete=django.db.models.deletion.CASCADE, related_name='historis', to='running.day', verbose_name='День тренировки')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('achievement_id', models.ForeignKey(db_comment='Достижение, полученное пользователем.', help_text='Достижение, полученное пользователем.', on_delete=django.db.models.deletion.CASCADE, related_name='user_achievements', to='running.achievement', verbose_name='Достижение')),
                ('user_id', models.ForeignKey(db_comment='Пользователь, который получил достижение.', help_text='Пользователь, который получил достижение.', on_delete=django.db.models.deletion.CASCADE, related_name='user_achievements', to=settings.AUTH_USER_MODEL, verbose_name='Пользователь')),
            ],
            options={
