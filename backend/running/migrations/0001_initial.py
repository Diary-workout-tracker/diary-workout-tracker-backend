# Generated by Django 5.0.2 on 2024-02-26 20:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('duration', models.DurationField(verbose_name='Время упражнения')),
                ('pace', models.CharField(choices=[('Walk', 'Ходьба'), ('Run', 'Бег')], db_comment='Вид нагрузки упражнения.', help_text='Вид нагрузки упражнения.', max_length=20, verbose_name='Вид нагрузки')),
            ],
            options={
                'verbose_name': 'Этап',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(db_comment='Название достижения.', help_text='Название достижения.', max_length=150, verbose_name='Название достижения')),
                ...
                ('reward_points', models.PositiveSmallIntegerField(db_comment='Количество заморозок за достижение.', default=1, help_text='Количество заморозок за достижение.', max_length=7, verbose_name='Заморозк')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='day',
            name='workout',
            field=models.ManyToManyField(related_name='day', to='running.stage', verbose_name='Тренеровка'),
        ),
        migrations.CreateModel(
